...
- [ ] Phase 0:entry _(pending)_
- [ ] Phase 0:review _(pending)_
- [ ] Phase 0:approval _(pending)_
- [ ] Phase 0:exit _(pending)_

#### Phase 1

- [ ] Phase 1:entry _(pending)_
- [ ] Phase 1:review _(pending)_
- [ ] Phase 1:approval _(pending)_
- [ ] Phase 1:exit _(pending)_

#### Phase 2

- [ ] Phase 2:entry _(pending)_
...
| P2-01 | P17-G1-02A | planned | required-pr |
...
| ID | Primary group | Status | Tier |
|---|---|---|---|
| EWP-CF-001 | P17-G0-03 | planned | required-pr |
...
| EWP-CF-010 | P17-G0-02 | planned | required-pr |
...
| EWP-CF-023 | P17-G0-02 | planned | required-pr |
...
| EWP-CF-043 | P17-G1-02A | planned | required-pr |
...
| EWP-OPT-TS10 | P17-G1-02A | planned | required-pr |
...
| EWP-WF15 | P17-G1-02A | planned | required-pr |
...
Phase: 0; status: **planned**; dependencies: none.
Required-now validations: EWP-P0A-TS01, EWP-P0A-TS06, EWP-P0A-TS07.
Downstream coverage obligations: none.

### Group gates

- [ ] P17-G0-01:mapped _(pending)_
- [ ] P17-G0-01:ready _(pending)_
- [ ] P17-G0-01:test-first _(pending)_
- [ ] P17-G0-01:minimal-implementation _(pending)_
- [ ] P17-G0-01:targeted-green _(pending)_
- [ ] P17-G0-01:impacted-green _(pending)_
- [ ] P17-G0-01:refactor _(pending)_
- [ ] P17-G0-01:adversarial-review _(pending)_
- [ ] P17-G0-01:traceability-closure _(pending)_
- [ ] P17-G0-01:signed-off _(pending)_

### Tracked entities

- [ ] **EWP-P0A-T01** — Preserve the resolved D-001..D-016 answer, rationale, rejected option, affected _(phase-task; planned)_
- [ ] **EWP-P0A-T06** — Amend this plan and close every accepted finding. _(phase-task; planned)_
- [ ] **EWP-P0A-T10** — Maintain accepted-finding traceability: every finding must retain the accepted _(phase-task; planned)_
- [ ] **EWP-P0A-TS01** — Identifier/heading/decision-status validation. _(phase-test; planned)_
- [ ] **EWP-P0A-TS06** — No unresolved decision, undefined/duplicate EWP ID, count mismatch, stale _(phase-test; planned)_
- [ ] **EWP-P0A-TS07** — Every accepted EWP-CF row maps to a finding record, normative go-forward _(phase-test; planned)_

## P17-G0-02 — Live-to-target CLI migration ledger and complete parser/option ownership

Phase: 0; status: **planned**; dependencies: P17-G0-01.
...
- [ ] P17-G0-02:mapped _(pending)_
- [ ] P17-G0-02:ready _(pending)_
...
- [ ] **EWP-CF-010** — Make every command and option a testable parser contract _(finding; planned)_
- [ ] **EWP-CF-023** — Make the current-to-1.0 CLI migration explicit and closed _(finding; planned)_
- [ ] **EWP-OPT-TS01** — Introspect the live Commander tree and fail on any option/argument/alias absent _(option-gate; planned)_
- [ ] **EWP-P0A-T02** — Compare every proposed command/option against live Commander declarations. _(phase-task; planned)_
- [ ] **EWP-P0A-T07** — Keep the normative command/option registry synchronized with implementation _(phase-task; planned)_
- [ ] **EWP-P0A-T11** — Maintain the current-to-1.0 CLI migration ledger from a live Commander snapshot; _(phase-task; planned)_
...
- [ ] P17-G0-03:mapped _(pending)_
- [ ] P17-G0-03:ready _(pending)_
...
- [ ] **EWP-CF-001** — Correct phase dependencies before extending command-specific orchestration _(finding; planned)_
- [ ] **EWP-P0A-T03** — Compare manifest/lock/plan terminology against config and placement schemas. _(phase-task; planned)_
- [ ] **EWP-P0A-T04** — Run factor-architect review: good precedent, bad precedent, broken precedent, new _(phase-task; planned)_
- [ ] **EWP-P0A-T05** — Run broad consistency/quality scan for contradictions, duplicate semantics, _(phase-task; planned)_
...
- [ ] **EWP-OPT-TS06** — Exhaust zero-target, positional-plus-all, unmatched target/glob, filter-to-zero, _(option-gate; planned)_
...
- [ ] **EWP-P1-TS01** — Global option spawned-CLI matrix plus root/nested cwd, `-C`, Git worktree, _(phase-test; planned)_
- [ ] **EWP-P1-TS02** — Config precedence spawned-CLI matrix, including nested discovered manifest, _(phase-test; planned)_
- [ ] **EWP-P1-TS03** — Invalid enum/capability matrix for every command plus cross-command _(phase-test; planned)_
- [ ] **EWP-WF14** — Scope/shadowing and custom paths _(workflow; planned)_
...
- [ ] P17-G1-02A:mapped _(pending)_
- [ ] P17-G1-02A:ready _(pending)_
- [ ] P17-G1-02A:test-first _(pending)_
- [ ] P17-G1-02A:minimal-implementation _(pending)_
- [ ] P17-G1-02A:targeted-green _(pending)_
- [ ] P17-G1-02A:impacted-green _(pending)_
- [ ] P17-G1-02A:refactor _(pending)_
- [ ] P17-G1-02A:adversarial-review _(pending)_
- [ ] P17-G1-02A:traceability-closure _(pending)_
- [ ] P17-G1-02A:signed-off _(pending)_

### Tracked entities

- [ ] **EWP-CF-004** — Complete exit taxonomy and semantic precedence _(finding; planned)_
- [ ] **EWP-CF-043** — Close meaningless approval and contradictory preview modes _(finding; planned)_
- [ ] **EWP-OPT-TS04** — Assert mutation, prompt, JSON, and exit behavior for each option family. _(option-gate; planned)_
- [ ] **EWP-OPT-TS10** — Exhaust the shared non-mutating mode matrix: yes conflicts every dry-run/check; _(option-gate; planned)_
- [ ] **EWP-P1-T04** — Shared human/JSON error mapping. _(phase-task; planned)_
- [ ] **EWP-P1-T08** — Centralize the global exit taxonomy and batch precedence; remove unrestricted _(phase-task; planned)_
- [ ] **EWP-P1-TS06** — Cross-command 0-7/130 exit matrix, including batch error-over-drift precedence. _(phase-test; planned)_
- [ ] **EWP-WF15** — Noninteractive and output contracts _(workflow; planned)_
- [ ] **P0-06** — Human/JSON error boundary _(recommendation; planned)_
- [ ] **P2-01** — Consistent output selection _(recommendation; planned)_
...
- [ ] P17-G2-05:mapped _(pending)_
- [ ] P17-G2-05:ready _(pending)_
- [ ] P17-G2-05:test-first _(pending)_
...
- [ ] **EWP-P2-T06** — Implement manifest, lock, plan, ledger v1/v2, and journal codecs plus explicit _(phase-task; planned)_
