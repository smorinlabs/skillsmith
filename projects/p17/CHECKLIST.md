...
Tracked entities: **426** across **45** change groups.
...
- [x] Phase 4:review _(passed)_
- [x] Phase 4:approval _(passed)_
- [x] Phase 4:exit _(passed)_
...
| EWP-CF-044 | P17-G5-04 | planned | required-pr |
...
- [x] P17-G5-01:minimal-implementation _(passed)_
...
- [x] P17-G5-02:minimal-implementation _(passed)_
- [x] P17-G5-02:targeted-green _(passed)_
...
- [ ] **EWP-CF-044** — Close GC inventory, measurement, action, and crash semantics _(finding; planned)_
- [ ] **EWP-CMD-GC-TS01** — fixed configured store-root candidates with live/ledger-authoritative _(command-test; planned)_
...
- [ ] **EWP-P5-T06** — Reachability graph and GC retention. _(phase-task; ready)_
