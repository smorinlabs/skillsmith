...
- [x] P17-G3B-05:traceability-closure _(passed)_
- [x] P17-G3B-05:signed-off _(passed)_

### Tracked entities

- [x] **EWP-P3B-T06** — Move all tool-specific root, verification policy, placement, legacy-notice, and _(phase-task; signed-off)_
- [x] **EWP-P3B-TS06** — Static known-tool-branch ban; generic orchestration through fixture adapters; _(phase-test; signed-off)_
