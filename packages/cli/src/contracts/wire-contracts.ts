...
export const currentWireCommandMappings = Object.freeze([
  ...
  mapping('skillsmith search', 'search', 1),
...
export const currentWireCodecs = Object.freeze({
  ...
  crossToolNames: boundCodec('skillsmith cross-tool-names', crossToolNamesV1Codec),
  ...
  gc: boundCodec('skillsmith gc', gcV1Codec),
  ...
  search: boundCodec('skillsmith search', searchV1Codec),
