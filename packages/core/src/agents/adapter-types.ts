...
export const readOnlyOperations = (tool: string): ToolDescriptor['operations'] => ({
  ...
  'inventory-commands': fact(READ_SCOPES, null),
  diagnostics: fact(READ_SCOPES, null),
  install: fact([], `${tool} is read-only; choose claude-code, codex, or muse`),
  uninstall: fact([], `${tool} is read-only; choose claude-code, codex, or muse`),
  dev: fact([], `${tool} is read-only; choose claude-code, codex, or muse`),
  promote: fact([], `${tool} is read-only; choose claude-code, codex, or muse`),
  undo: fact([], `${tool} is read-only; choose claude-code, codex, or muse`),
