#!/usr/bin/env python3
"""One selected Linux CI timing observation of the pinned instrumented subject."""
import ctypes
import hashlib
import json
import os
...
HEAD = '01244fbe32e8d18d98c6de9d03662b5b1972f740'
TREE = 'e2e59aa57eca2c70f37e0a3b47c002bb239593ee'
PARENTS = ['59169deeeaaea2302fb2234bf2dcb67293008bca']
...
INPUTS = {
    OWNER: 'a761002a66c024418558986d1e5c57db400a9e97a82ae76daa93f64b31b1f9a6',
...
def worker():
    ...
    before = None
    try:
        assert os.environ['GITHUB_REF'] == 'refs/heads/agent/p19-p17-ci-timing'
        ...
        run_command('selected', argv, env, 930, 960)  # Diagnostic900 s test; normal930+15 cleanup, outer945+15 fallback.
        junit()
        ...
        if 'this test timed out after 900000ms' in diagnostic_stderr:
            primary = 'selected_test_timeout_900000ms'
        ...
        if result['evidence_complete'] and primary == 'selected_test_timeout_900000ms':
