#!/usr/bin/env python3
"""One selected Linux CI proof of the pinned uninstrumented timeout fallback."""
import ctypes
import hashlib
import json
import os
...
HEAD = 'dda3729874c8cc0d4f19594282113be430495197'
TREE = '4d0f17b78064901f3d4258dc06afb6bf5c2f5a39'
...
INPUTS = {
    OWNER: '8331ac6ac0666b434e4faac17fa3f088c016fac419edbd65874a38ae20e43aef',
...
def worker():
    ...
    before = None
    try:
        assert os.environ['GITHUB_REF'] == 'refs/heads/agent/p19-p17-ci-timeout'
        ...
        run_command('selected', argv, env, 630, 660)  # Test600 s; normal630+15 cleanup, outer645+15 fallback.
        junit()
        ...
        if 'this test timed out after 600000ms' in diagnostic_stderr:
            primary = 'selected_test_timeout_600000ms'
        ...
        if result['evidence_complete'] and primary == 'selected_test_timeout_600000ms':
