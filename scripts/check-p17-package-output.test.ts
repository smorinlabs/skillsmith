...
const expectedV1 =
  'structurally valid; preparation/PR/merge readiness was not asserted: 86 prep IDs, 23 local links, valid: 425 entities (418 required, 7 deferred; 244 validation obligations), 45 groups, deterministic checklist';
